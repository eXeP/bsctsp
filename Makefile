...
solver: cuda_2opt.o cuda_preprocessing.o 
	g++ --std=c++17 -g -o solver -L/opt/cuda/lib64 -lcuda -lcudart src/solver.cpp src/2opt.cpp src/preprocessing.cpp src/util.cpp cuda_2opt.o cuda_preprocessing.o  -fopenmp -lpthread -O3 -Wextra -Wall
